...
* 1、项目起步
    ...
    * 环境安装
        ...
        * dnpm安装 ```如需使用dnpm安装请参照以下指令```

                npm install -g dnpm --registry=http://registry.npm.xiaojukeji.com

            或者

                npm set registry http://registry.npm.xiaojukeji.com

            更多dnpm信息请访问：[http://npm.xiaojukeji.com/](http://npm.xiaojukeji.com/)
